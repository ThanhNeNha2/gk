		...
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>User firtName</label> <input type="text"
						value="<c:out value='${user.firtName}' />" class="form-control"
						name="firtName" required="required">
				</fieldset>
				...
				<fieldset class="form-group">
					<label>User groupp</label>
					<select  value="<c:out value='${user.groupp}' />" class="form-control"
						name="groupp">
